...
return [
    ...
    'statusMessages' => [
        'confirm' => 'You must confirm your email address before logging in. An email has been sent to {{ $email }}. If you have not received the confirmation email, we can <a href="{{ url(\'/confirm/\' . $user_id . \'/resend\') }}">resend it</a>.',
